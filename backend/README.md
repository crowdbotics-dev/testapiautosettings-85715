...
## Project Structure
    ...
    ├── testapiautosettings_85715  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_85715`
...
2. Clone this repo and `cd testapiautosettings_85715`
